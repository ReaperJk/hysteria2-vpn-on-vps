...
- 6.Откройте сайт https://hysteriaconfig.xyz, укажите там имя и пароль пользователя(терминал должен был вывести в последних сообщениях), пример:"vpn:67e521c8dac3eac9b2f0fe409b33955b".
